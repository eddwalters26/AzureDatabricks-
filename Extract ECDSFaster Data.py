...
CONTROL_FILE_DATUM = "Arrival_Date"
...
entities = {
    "ECDSFaster": {
        "basePath": BASE_SOURCE_PATH + "/EC_Core/Published/1",
        "children": {
            "ECDSFasterAlcohol": {
                "basePath": BASE_SOURCE_PATH + "/EC_AlcoholDrugInvolvement/Published/1"
            },
            "ECDSFasterClinicalCodedFindings": {
                "basePath": BASE_SOURCE_PATH + "/EC_ClinicalCodedFindings/Published/1"
            },
            "ECDSFasterClinicalCodedScoredAssessments": {
                "basePath": BASE_SOURCE_PATH
                + "/EC_ClinicalCodedScoredAssessments/Published/1"
            },
            "ECDSFasterComorbidities": {
                "basePath": BASE_SOURCE_PATH + "/EC_Comorbidities/Published/1"
            },
            "ECDSFasterDiagnosis": {
                "basePath": BASE_SOURCE_PATH + "/EC_Diagnosis/Published/1"
            },
            "ECDSFasterInvestigations": {
                "basePath": BASE_SOURCE_PATH + "/EC_Investigation/Published/1"
            },
            "ECDSFasterTreatment": {
                "basePath": BASE_SOURCE_PATH + "/EC_Treatment/Published/1"
            },
        },
    }
}
...
config_path = BASE_EXTRACT_PATH + "/Config/ECDSFasterConfig.json"
...
try:
    fy_path = BASE_EXTRACT_PATH + "/ECDSFaster_PreviousFolders"
