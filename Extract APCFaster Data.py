...
FY_COLUMN_NAME = "Der_Spell_Financial_Year"
CONTROL_FILE_DATUM = "Discharge_Date"
...
entities = {
    "APCFaster": {
        "basePath": BASE_SOURCE_PATH + "/APCE_Core_Daily/Published/1",
        "children": {
            "APCFasterDiagnosis": {
                "basePath": BASE_SOURCE_PATH + "/APCE_Diag_Daily/Published/1/"
            },
            "APCFasterProcedure": {
                "basePath": BASE_SOURCE_PATH + "/APCE_Proc_Daily/Published/1"
            },
            "APCFasterWard": {
                "basePath": BASE_SOURCE_PATH + "/APCE_Ward_Daily/Published/1"
            }
        }
    },
    "APCFaster_Open": {
        "basePath": BASE_SOURCE_PATH + "/APCE_Open_Daily/Published/1",
    },
}
...
config_path = BASE_EXTRACT_PATH + "/Config/APCFasterConfig.json"
...
try:
    fy_path = BASE_EXTRACT_PATH + "/APCFaster_PreviousFolders"
