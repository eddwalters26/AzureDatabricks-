...
entities = {
    "APC": {
        "basePath": BASE_SOURCE_PATH + "/APCE_Core_Union",
        "children": {
            "APCDiagnosis": {
                "basePath": BASE_SOURCE_PATH + "/APCE_Diag_Union"
            },
            "APCProcedure": {
                "basePath": BASE_SOURCE_PATH + "/APCE_Proc_Union"
            },
            "APCWard": {
                "basePath": BASE_SOURCE_PATH + "/APCE_Ward_Union"
            }
        }
    }
}
...
config_path = BASE_EXTRACT_PATH + "/Config/APCPlusConfig.json"
...
try:
    fy_path = BASE_EXTRACT_PATH + "/APCPlus_PreviousFolders"
